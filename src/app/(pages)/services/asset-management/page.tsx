...
// Premium Asset Management hub page
...
export default function AssetManagementPage() {
  ...
  const solutions = [
    ...
    },
    {
      ...
      icon: "📊",
      description:
        "Monitor asset costs, depreciation, audits, and compliance requirements with centralized reporting and controls.",
    ...
    },
    {
      ...
      icon: "🗂️",
      description:
        "Maintain a centralized asset registry with streamlined work management and operational workflows.",
    ...
    },
    {
      ...
      icon: "🔍",
      description:
        "Digitize inspection workflows with real-time reporting, issue tracking, and maintenance visibility.",
          ...
          <StaggerIn>
            <div className={styles.faqLeft}>
              ...
              <p className={styles.faqSub}>
                Everything you need to know about deploying our asset management
                solutions across your organisation.
              </p>
            </div>
          </StaggerIn>
