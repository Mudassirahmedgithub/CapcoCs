...
export default function DataGovernancePage() {
  ...
  const techStack = [
    {
      category: "Data Governance Technologies",
      icon: <Server className="w-5 h-5" />,
      tools: ["Apache Atlas", "Collibra", "Alation", "Azure Purview", "AWS Glue Data Catalog"],
    },
    {
  ...
  const whyItems = [
    { icon: <ShieldCheck className="w-5 h-5" />, title: "Robust, Scalable Solutions", desc: "Enterprise-grade data governance architectures built to grow with your data volume and organizational complexity." },
    { icon: <Brain className="w-5 h-5" />, title: "Cross-Domain Expertise", desc: "Deep specialization across data governance consulting, AI, cloud platforms, and data engineering under one roof." },
    { icon: <ClipboardList className="w-5 h-5" />, title: "Governance-First Approach", desc: "Proven data governance frameworks for regulatory compliance and data quality that protect and unlock business value." },
    ...
    { icon: <BarChart2 className="w-5 h-5" />, title: "Business-First Mindset", desc: "Every data governance solution is anchored to measurable outcomes — cost reduction, revenue growth, and operational efficiency." },
  ];
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <h1 className={styles.heroTitle}>
            ...
            <br />
            <em>for AI & Compliance</em>
          </h1>

          {/* SEO: Primary keyword in first paragraph */}
          <p className={styles.heroDesc}>
            CAPCO CONSULTING SERVICES provides enterprise data governance services that help organizations
            improve data quality, security, compliance, and operational intelligence through scalable
            governance frameworks. Our data governance consulting ensures your data is accurate, secure,
            and strategically deployed to power automation, decision-making, and digital transformation.
          </p>
        </div>
      ...
      <section className={styles.servicesSection} id="data-governance">
          ...
          <StaggerIn>
            <div className={styles.sectionHeader}>
              ...
              <h2 className={styles.sectionTitle}>
                Enterprise Data Governance <em>Solutions</em>
              </h2>
              <p className={styles.sectionDesc}>
                We establish data governance frameworks that ensure data quality, security, consistency,
                and regulatory compliance across your entire organization. Our data governance consulting
                helps you build a trusted, auditable data estate.
              </p>
            </div>
          </StaggerIn>
      ...
      {/* ── AI & ML SECTION ───────────────────── */}
      <section className={styles.servicesSectionAlt} id="ai-services">
        <div className={styles.sectionInner}>
          <StaggerIn>
            <div className={styles.sectionHeader}>
              <span className={styles.eyebrow}>
              ...
              <p className={styles.sectionDesc}>
                ...
                predictive insights. Our AI services complement your data governance strategy to ensure
                models are built on trusted, compliant data.{" "}
                <Link href="/services/ai-machine-learning-services">
                  Explore our full AI Services →
                </Link>
              </p>
            </div>
          </StaggerIn>
      ...
      <section className={styles.servicesSection} id="data-engineering">
        <div className={styles.sectionInner}>
          <StaggerIn>
            <div className={styles.sectionHeader}>
              <span className={styles.eyebrow}>
              ...
              <p className={styles.sectionDesc}>
                Strong data governance begins with a strong data foundation. We design and implement
                enterprise-grade data pipelines and architectures optimized for speed, reliability,
                and scalability.{" "}
                <Link href="/services/data-engineering-services">
                  Explore our full Data Engineering Services →
                </Link>
              </p>
            </div>
          </StaggerIn>
        ...
        <div className={styles.sectionInner}>
          <StaggerIn>
            <div className={styles.sectionHeader}>
              ...
              <h2 className={styles.sectionTitle}>
                Data Governance & AI <em>Use Cases</em>
              </h2>
            </div>
          </StaggerIn>
          ...
          <StaggerIn>
            <div className={styles.sectionHeader}>
              ...
              <h2 className={styles.techTitle}>
                Technologies Used in <em>Data Governance</em>
              </h2>
              <p className={styles.techDesc}>
                Battle-tested data governance tools, frameworks, and cloud platforms chosen for
                production reliability and enterprise scale.
              </p>
            </div>
          </StaggerIn>
        ...
        <div className={styles.sectionInner}>
          <StaggerIn>
            <div className={styles.sectionHeader}>
              ...
              {/* SEO: Keyword-improved heading */}
              <h2 className={styles.sectionTitle}>
                Why Choose Our <em>Data Governance Services</em>
              </h2>
            </div>
          </StaggerIn>
        ...
        <div className={styles.faqInner}>
          <StaggerIn>
            <div className={styles.sectionHeader}>
              ...
              <h2 className={styles.sectionTitle}>
                Data Governance Services — <em>FAQs</em>
              </h2>
            </div>
          </StaggerIn>
        ...
        <div className={styles.ctaGlow} />
          <StaggerIn>
            ...
            <p className={styles.ctaDesc}>
              From data governance frameworks and regulatory compliance to advanced AI solutions and
              master data management, CAPCO CONSULTING SERVICES ensures your organization is ready
              for the future of data governance and intelligent automation.
            </p>
