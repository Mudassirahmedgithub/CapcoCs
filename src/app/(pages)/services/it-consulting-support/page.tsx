  ...
  return (
    <div className={styles.page}>
      ...
      <div className={`${styles.stickyCta} ${stickyVisible ? styles.stickyCtaVisible : ""}`}>
        <span className={styles.stickyCtaText}>Ready to transform your IT strategy?</span>
        <button className={styles.stickyCtaBtn}>Request a Consultation</button>
      </div>
        ...
        <div className={styles.ctaInner}>
          <FadeIn>
            ...
            <div className={styles.ctaActions}>
              <button className={styles.ctaBtnWhite}>Book a Free Session</button>
        ...
        <div className={styles.contactInner}>
          <div className={styles.contactLeft}>
            <FadeIn>
              ...
              <p className={styles.contactDesc}>
                Tell us about your technology challenges. Our consultants will get back
                to you within one business day.
              </p>
              <div className={styles.contactMeta}>
                <div className={styles.contactMetaItem}>
                  <span className={styles.contactMetaDot} />
                  Consultants available Mon–Fri
                </div>
                <div className={styles.contactMetaItem}>
                  <span className={styles.contactMetaDot} />
          ...
          <FadeIn delay={0.15}>
            <div className={styles.contactForm}>
              ...
              <div className={styles.formField}>
                <label className={styles.formLabel}>Consulting Need</label>
                <select className={styles.formInput}>
                  <option value="">Select a service area</option>
                  <option>IT Strategy & Roadmapping</option>
